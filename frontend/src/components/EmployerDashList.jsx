                ...
                <div className="single__shortlist__item bg-light">
                  <div className="author__info">
                    ...
                    <div className="author__info__list">
                      ...
                      <span>
                        <i className="fa-light fa-clock" /> 1 Year Ago
                      </span>
                    </div>
                  </div>
                  <div className="shortlist__action">
                    <button className="action__item__long">
                      <svg
                        width={18}
                        height={18}
                        viewBox="0 0 18 18"
...
export default EmployerDashList;
